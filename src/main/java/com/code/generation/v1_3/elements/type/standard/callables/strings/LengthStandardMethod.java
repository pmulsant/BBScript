...
public class LengthStandardMethod extends StandardMethod {
    ...
    private static final String RETURN_TYPE_NAME = StandardKnowledges.INT_TYPE_NAME;
    private static final List<String> PARAMETER_TYPE_NAMES = Collections.EMPTY_LIST;

    public LengthStandardMethod(StandardTypeDirectory standardTypeDirectory, TypeInferenceMotor typeInferenceMotor) {
