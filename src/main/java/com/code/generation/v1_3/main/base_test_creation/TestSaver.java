...
public class TestSaver {
    private static final String PREFIX = "failed/simple_statement/variable_errors/typed_variables";
    private static final String CODE_NAME = "int_initialization_with_boolean";
